...
<html lang="en">
  ...
  <div class="py-1 bg-primary st">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
          <a class="navbar-brand" href="index.php">USmart</a><h2>|&nbsp&nbsp</h2><img src="images/logoStore.PNG" width="30px">
          ...
          <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item"><a href="adminProduct.php" class="nav-link">Product List</a></li>
              <li class="nav-item"><a href="adminOrder.php" class="nav-link">Order List</a></li>
